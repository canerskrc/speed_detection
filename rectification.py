...
def rectify_image(image, clip_factor=6, algorithm='independent',
      ...
      warped_img, a = compute_homography_and_warp(image, vp1, vp2,
                                                  clip_factor=clip_factor)

      return warped_img, a


def matrix_homorgenous(frame):
      img, a = rectify_image(frame, 4, algorithm='independent')
      return a
# if __name__ == '__main__':
#     # import time
#     # time1= time.time()
#     image_name = "frame5.png"
#     # h_o,w_o= cv2.imread(image_name).shape[:2]
#     img_rot=cv2.imread("frame5_warped.png")
#     h,w= img_rot.shape[:2]
#     print(h,w)
#     # image_name= cv2.circle(image_name, (275,300), 10, (0,0,255),2)

#     # image = io.imread(image_name)
#     print("Rectifying {}".format(image_name))
#     save_name = '.'.join(image_name.split('.')[:-1]) + '_warped.png'
#     img,a=rectify_image(image_name, 4, algorithm='independent')
#     print(a)
#     print(transform.matrix_transform((275,300), a))
#     image_new= cv2.circle(img_rot, (X,Y), 10, (0,0,255),2)

# #     cv2.imshow("imge",cv2.resize(img_rot, (700,700)))
# #     cv2.waitKey(0)
...
#     #         continue
#     #     if ret:
#     #         frame=rectify_image(frame, 4, algorithm='independent')
